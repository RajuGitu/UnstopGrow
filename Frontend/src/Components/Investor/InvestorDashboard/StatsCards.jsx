  ...
  const mockContactRequests = [
    {
      ...
      message:
        "I'm interested in your renewable energy solutions and would like to discuss potential investment opportunities.",
    },
    {
      id: 2,
      ...
      message:
        "Your healthcare AI platform looks promising. I'd love to learn more about your go-to-market strategy.",
    },
    {
      id: 3,
      startup: "FinFlow",
      ...
      message:
        "Interested in your B2B fintech solution. Can we schedule a call?",
    },
  ];
