...
import { Bookmark, Heart, MapPin, Users, TrendingUp, FileText, Eye } from "lucide-react";
    ...
    return (
      <Card className="hover:shadow-lg transition-all duration-200 hover:-translate-y-1">
        ...
        <CardContent className="space-y-4">
          <p className="text-gray-700 text-sm leading-relaxed">{startup.tagline}</p>
          ...
          <div className="space-y-2">
            <div className="flex justify-between text-sm">
              ...
              <span className="font-medium">
                ₹{(startup.currentFunding / 100000).toFixed(1)}L / ₹{(startup.fundingGoal / 100000).toFixed(1)}L
              </span>
            </div>
