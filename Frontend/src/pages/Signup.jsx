...
const Signup = () => {
  ...
  const inputClass =
    "w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500";
  ...
  const renderFounderFields = () => {
    ...
    return (
      <>
        ...
        {!/^[A-Z]{5}[0-9]{4}[A-Z]$/.test(f.pancard.toUpperCase()) &&
          f.pancard && (
            <p className="text-xs text-red-500">
  ...
  const renderInvestorFields = () => {
    ...
    return (
      <>
        ...
        {!/^[A-Z]{5}[0-9]{4}[A-Z]$/.test(i.pancard.toUpperCase()) &&
          i.pancard && (
            <p className="text-xs text-red-500">
              Invalid PAN format (e.g., ABCDE1234F)
            </p>
